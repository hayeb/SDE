...
public class AddTaskActivity extends AppCompatActivity implements RescheduleDialog.RescheduleDialogListener {
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		final Button doneButton = findViewById(R.id.buttonDone);
	...
	public void onReschedule() {
		Toast.makeText(this, "Succesfully rescheduled!", Toast.LENGTH_LONG).show();
		navigateToParent();
	}
